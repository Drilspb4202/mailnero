    ...
    constructor() {
        ...
        this.translations = {
            'ru': {
                ...
                'vpn_warning': 'Для корректной работы сервиса необходимо использовать VPN. В настоящее время сервис может работать нестабильно на мобильных устройствах.',
            ...
            'en': {
                ...
                'vpn_warning': 'A VPN is required for the service to work correctly. Currently, the service may work unstable on mobile devices.',
                'public_api_note': 'When using the public API key, mailboxes are automatically deleted after 5 minutes.',
